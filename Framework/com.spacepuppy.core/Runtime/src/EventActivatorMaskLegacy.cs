...
namespace com.spacepuppy
{
    ...
    [CreateAssetMenu(fileName = "EventActivatorMask", menuName = "Spacepuppy/EventActivatorMask-Legacy")]
    public class EventActivatorMaskLegacy : ScriptableObject, IEventActivatorMask
    {
