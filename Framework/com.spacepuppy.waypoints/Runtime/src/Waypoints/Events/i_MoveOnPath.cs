...
namespace com.spacepuppy.Waypoints.Events
{

    /// <summary>
    /// TODO - remove obsolete deltaType
    /// </summary>
    public class i_MoveOnPath : AutoTriggerable, IObservableTrigger
    {
        ...
        [SerializeField()]
        private SPEvent _onFinish = new SPEvent(TRG_ONFINISH);
